...
pub struct TopLevelItem<'src> {
    ...
    /// The span of the top-level item in the source code.
    pub span: Span,
}
...
pub struct Struct<'src> {
    ...
    /// The span of the struct in the source code.
    pub span: Span,
}
...
pub enum StmtKind<'src> {
    ...
    Assign(Option<BinaryOp>, Box<Expr<'src>>, Box<Expr<'src>>),
    ...
    If(Box<Expr<'src>>, Box<Block<'src>>, Option<Box<Block<'src>>>),
...
pub enum ExprKind<'src> {
    ...
    FunctionCall(Box<Identifier<'src>>, Vec<Expr<'src>>),
    ...
    IntrinsicCall(Box<Identifier<'src>>, Vec<Expr<'src>>),
